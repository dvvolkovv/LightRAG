...
RUN --mount=type=cache,id=s/9379015b-81cf-4eae-952c-973a6cdc1c6c-bun-install-cache,target=/root/.bun/install/cache \
    cd lightrag_webui \
...
RUN --mount=type=cache,id=s/9379015b-81cf-4eae-952c-973a6cdc1c6c-uv-cache,target=/root/.local/share/uv \
