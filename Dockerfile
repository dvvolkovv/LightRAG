...
RUN --mount=type=cache,id=s/5f670cb0-55ee-43ad-9841-2d9251a78b59,target=/root/.bun/install/cache \
    cd lightrag_webui \
...
RUN --mount=type=cache,id=s/5f670cb0-55ee-43ad-9841-2d9251a78b59,target=/root/.local/share/uv \
